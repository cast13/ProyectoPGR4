...
async def modificar_producto(producto_id: UUID, producto: Producto):  # Cambiar a UUID
...
async def borrar_producto(producto_id: UUID):  # Cambiar a UUID
    return eliminar_producto(producto_id)

@router.get("/{producto_id}", response_model=Producto)
async def obtener_producto(producto_id: UUID):  # Cambiar a UUID
